        ...
        <div className="fade-in show grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center mt-24 md:mt-32">
          ...
          <div className="">
            ...
            <p className="mb-4">
              ...
              applications that users love. i prefer building with next.js,
              node.js, sanity, tailwind, and figma. my soft skills compliment my
              tech chops, allowing me to collaborate effectively with
              leadership, design, and engineering teams every step of the way.
              i&apos;m a lightning-fast learner and am committed to delivering
