            ...
            <main className="animate__animated animate__fadeIn mt-24 pb-36 max-w-[80vw] lg:max-w-[70vw] mx-auto">
                ...
                <div className='flex flex-col gap-16 md:gap-32'>
                    ...
                    <PhotoLeftCard
                        ...
                        githubUrl={'https://github.com/gabewolford/islamorada-fishing-guides'}
                        siteUrl={'https://islamoradafishingguidesandcharters.com'}
                        projectName={'islamorada fishing guides'}
                        monthAndYear={'april 2023'}
                        technologies={'frontend development, SEO, site migration, react, next, node, sanity, tailwind, vercel, figma'}
                    ...
                    <PhotoLeftCard
                        ...
                        monthAndYear={'july 2023'}
                        technologies={'next.js, react, node, tailwind, sanity, vercel, figma'}
                        ctaText={'check it out'}
                    >
                    </PhotoLeftCard>
                    ...
                    <PhotoLeftCard
                        ...
                        technologies={'react, express, mongoDB, node, heroku, javascript, tailwind, figma'}
                        ctaText={'check it out'}
                    >
                    </PhotoLeftCard>
